...
export {PostFixExpression};
class PostFixExpression {

  originalInfixExpressionAsString: string;
  postFixExpressionAsArray: Array<string>;
   ...
   */
  getInfixStringToPostfixArray(infixExpression: string) {

    let operatorValueMap: any = {
      ")": 5,
      "^": 4,
      "*": 3,
      "/": 3,
    ...
    for (let i = 0; i < infixExpression.length; i++) {
      let item: string = infixExpression.charAt(i);
