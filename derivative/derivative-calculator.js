...
(function () {
     ...
     */
    function init() {
        var differentiateButton = id("differentiate-button");
    ...
    function computeExpression() {
        var infixExpression = id("expression").value;
        var postFixExpression = new PostFixExpression(infixExpression);

        var expressionTree = new ExpressionTree(postFixExpression.postFixExpressionAsArray);


        var derivative = expressionTree.differentiateTree();
    ...
    function displayResult(derivative) {
        var derivativeElement = document.createElement("div");
        derivativeElement.textContent = derivative;
        var log = id("derivatives");
