...
online(such as Wolfram Alpha) and I was fascinated by them, so I wanted to learn how they worked. My computer does symbolic computations(so, it computes derivative functions and indefinite integrals), because using the limit definitions of the derivative and integral and then applying approximations methods would be too easy.
...
<aside><b>Important note:</b> Calculus is awesome!</aside>
